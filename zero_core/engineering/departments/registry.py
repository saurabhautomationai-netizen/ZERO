...
class DepartmentRegistry:
    ...
    def find_for_task(self, task_description: str) -> Optional[DepartmentSpec]:
        ...
        keywords_map = {
            ...
            "database": ["database", "sql", "migration", "postgres", "supabase", "table", "schema"],
    ...
    def seed_defaults(self) -> None:
        ...
        defaults = [
            DepartmentSpec(
                ...
                member_worker_ids=["worker_coding_agent", "worker_project_builder"],
            ...
            DepartmentSpec(
                ...
                member_worker_ids=["worker_project_builder"],
            ...
            DepartmentSpec(
                ...
                member_worker_ids=["worker_research_agent"],
            ...
            DepartmentSpec(
                ...
                lead_worker_id="worker_coding_agent",
                member_worker_ids=["worker_coding_agent"],
